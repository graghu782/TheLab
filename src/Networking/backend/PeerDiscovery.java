...
public class PeerDiscovery
{
	...
	public void run()
	{
		...
		DatagramPacket tx = new DatagramPacket(new byte[]
		{ RESPONSE_PACKET }, 1, group, port);
     ...
     * @throws IOException
     */
    public PeerDiscovery(InetAddress group, int port, int ttl) throws IOException
    {
	/*
